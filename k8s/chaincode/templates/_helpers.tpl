...
{{ include "chaincode.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "chaincode.selectorLabels" -}}
...
*/}}
{{- define "chaincode.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "chaincode.fullname" .) .Values.serviceAccount.name }}
{{- else }}
